...
//		}
		...
		if(text != null){
			...
			params.setMargins(DisplayUtils.INSTANCE.dp2px(5, getResources()), DisplayUtils.INSTANCE.dp2px(5, getResources()),
					DisplayUtils.INSTANCE.dp2px(5, getResources()), DisplayUtils.INSTANCE.dp2px(5, getResources()));
...
//					textView.setLayoutParams(params);
		...
		rippleSpeed = attrs.getAttributeFloatValue(MATERIALDESIGNXML,
				"rippleSpeed", DisplayUtils.INSTANCE.dp2px(6, getResources()));
	}
...
//		centrarTexto();
		super.onDraw(canvas);
		if (x != -1) {
			Rect src = new Rect(0, 0, getWidth()-DisplayUtils.INSTANCE.dp2px(6, getResources()), getHeight()-DisplayUtils.INSTANCE.dp2px(7, getResources()));
			Rect dst = new Rect(DisplayUtils.INSTANCE.dp2px(6, getResources()), DisplayUtils.INSTANCE.dp2px(6, getResources()), getWidth()-DisplayUtils.INSTANCE.dp2px(6, getResources()), getHeight()-DisplayUtils.INSTANCE.dp2px(7, getResources()));
