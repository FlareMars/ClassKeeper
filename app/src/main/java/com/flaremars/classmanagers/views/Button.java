...
public abstract class Button extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(DisplayUtils.INSTANCE.dp2px(minHeight, getResources()));
		setMinimumWidth(DisplayUtils.INSTANCE.dp2px(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - DisplayUtils.INSTANCE.dp2px(6, getResources()), getHeight()
						- DisplayUtils.INSTANCE.dp2px(7, getResources()), Config.ARGB_8888);
