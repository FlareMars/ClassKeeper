...
//                Toast.makeText(JoinClassActivity.this,"找到啦~",Toast.LENGTH_LONG).show();
                                    ...
                                    targetConversation.join(new AVIMConversationCallback() {
                                        ...
                                        public void done(AVException e) {
                                            if (e == null) {
                                                    ...
                                                    query2.findInBackground(new FindCallback<AVObject>() {
                                                        ...
                                                        public void done(List<AVObject> list, AVException e) {
                                                            if (e == null) {
                                                                ...
                                                                NormalUtils.INSTANCE.showErrorLog(JoinClassActivity.this,e);
                                                            }
                                                        }
                                                    });
                                                }
                                                ...
                                                //加入工作完成
                                                progressDialog.dismiss();
                                                Toast.makeText(CMApplication.GLOBAL_CONTEXT, "加入成功", Toast.LENGTH_LONG).show();
                                                ...
                                                if (userPersonalInfo.getAcademy() == null || userPersonalInfo.getAcademy().equals("")) {
                                                    ...
                                                    dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                                                        ...
                                                        public void onDismiss(DialogInterface dialog) {
                                                            ...
                                                            joinClassFinished(userPersonalInfo, classId, className);
                                                        }
                                                    });
                                                    dialog.show();
                                                } else {
                                                ...
                                                progressDialog.dismiss();
                                                NormalUtils.INSTANCE.showErrorLog(JoinClassActivity.this, e);
                                                NormalUtils.INSTANCE.showToast(JoinClassActivity.this, "当前网络状态欠佳，请稍候再试");
                                            }
                                        }
                                    });
                                } else {
    ...
    //设置用户当前班级数据，并进行跳转
    private void joinClassFinished(UserPersonalInfo userPersonalInfo, final String classId, final String className) {
